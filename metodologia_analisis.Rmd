...
spotify <- read_csv("C:/Users/vegas/Desktop/Spotify G4-G7.csv")
...
1.la base de datos corresponde a un lapso de tiempo de octubre del a
...
Volumen: Nivel de sonido percibido en una grabación o interpretación musical. Puede variar dentro de una canción y entre diferentes géneros musicales, por ende, se relacionará a los géneros musicales con más y menos popularidad.

Energía: Sensación de intensidad y dinamismo en una pieza musical. Los géneros pueden variar desde muy energéticos, hasta más tranquilos. 

Explicitud: Grado en que las letras de las canciones contienen lenguaje, temas o imágenes explícitas que pueden no ser apropiadas para todas las audiencias.
...
#en este apartado estan los df que usaremos para el trabajo
